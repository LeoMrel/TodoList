export const cardStyles = "p-4 w-11/12 md:w-5/12 md:p-10 rounded-lg border border-gray-400 bg-gray-200 shadow-2xl dark:bg-gray-900 dark:border-gray-700 transition-colors duration-200"
...
export const buttonStyles = "w-full shadow-xl text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
