...
export const buttonStyles = "w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
...
export const PasswordRequirements = ({password}) => {
    ...
    return (
        <div className="bg-gray-300 rounded-md container my-1 px-2 py-1 dark:bg-gray-800 dark:text-white transition-colors relative">
            <div className="h-4 w-10 rotate-45 rounded-sm bg-gray-300 dark:bg-gray-800 transition-colors absolute" />
